...
//        self.setNavigationBarLargeTitleDisplay(Mode: .never)
        ...
        //分割线边距
        self.tableView.separatorInset = UIEdgeInsets(top: 0, left: 0, bottom: 10, right: 0)
        //iOS11 fromCellEdges时左边距为0生效
        self.tableView.separatorInsetReference = .fromCellEdges
        self.tableView.separatorEffect = UIVisualEffect()

        //
        vm.bindDataSource(view: self.tableView, disposeBag: disposeBag)
//        self.tableView.rx.modelSelected(<#T##T#>)
    }
